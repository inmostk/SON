...
import pymysql, json, random, string, DB_Session, sys
...
def login(request) :
    ...
    conn = pymysql.connect(host=DBSS.host, port=DBSS.port, user=DBSS.user, password=DBSS.password, db=DBSS.db, charset=DBSS.charset)
